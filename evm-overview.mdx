...
Flash API supports advanced orders for any ERC-20 token on 11 EVM chains: Ethereum, Base, Arbitrum, Avalanche, BNB Chain, HyperEVM, Monad, Optimism, Plasma, Polygon, and Robinhood. Aggregated liquidity across 200+ DEXs and liquidity sources feeds the Flash smart order router.
