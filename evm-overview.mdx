...
Flash API supports advanced orders for any ERC-20 token on 10 EVM chains: Ethereum, Base, Arbitrum, Avalanche, BNB Chain, HyperEVM, Monad, Optimism, Plasma, and Polygon. Aggregated liquidity across 200+ DEXs and liquidity sources feeds the Flash smart order router.
