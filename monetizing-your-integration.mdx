...
<Note>
  The 10 bps rate is a **promotional launch rate**, in effect for the first **6 months**. Pricing may change after the promotional period. **Enterprise and high-volume integrators** may be able to access custom pricing — [reach out](https://www.definitive.fi/flash-api#contact) to the Definitive team.
</Note>
