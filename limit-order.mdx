...
| `limitCrossPrice` | One of the two | Pair rate: `contraAsset` units per one `targetAsset` unit, same frame on buy and sell. Buy fills at or below, sell fills at or above |
